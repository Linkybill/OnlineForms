...
import { ActiveListFieldNames, ListNames } from "../../../extensions/formTemplateListActions/Constants";
    ...
    const tryRedirectToFormWeb = async () => {
      ...
      if (searchParams.has(formWebUrlParameterName) && searchParams.has(formIdentifierParameterName)) {
        ...
        if (searchParams.has("ID")) {
          ...
          if (isModern) {
            var formItem = await sp.web.lists.getByTitle(ListNames.aktiveFormsListName).items.getById(Number.parseInt(id)).get();
