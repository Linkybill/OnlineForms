...
import { loadFormTemplate, updateTemplate } from "../../../common/formTemplates/services/FormTemplateService";
...
export const FormTemplateEditorWebPart = (props: IFormTemplateEditorWebPartProps): JSX.Element => {
  ...
  React.useEffect(() => {
    const loadTemplate = async () => {
      ...
      if (params.has("templateItemId")) {
        let templateItemId: number | undefined = undefined;
        try {
          const param = params.get("templateItemId");
        ...
        setError("Es wurde in der URL kein templateItemId angegeben. Ohne Template kann der Editor nicht angezeigt werden.");
        setIsLoading(false);
      }
    };
              ...
              <LoadingIndicatorContextProvider isLoading={isLoading} message="">
                {isLoading === false && (
                  <>
                    ...
                    {error === undefined && (
                      <>
                        <PermissionContextProvider listItemId={undefined}>
